<template>
    <div class="contact-content-form-lastname-container">
        ...
        <div class="contact-content-form-lastname-input-container">
            <input type="text" id="lastname" class="contact-content-form-lastname-input" placeholder="Smith">
        </div>
    </div>
    <div class="contact-content-form-firstname-container">
        ...
        <div class="contact-content-form-firstname-input-container">
            <input type="text" id="firstname" class="contact-content-form-firstname-input" placeholder="John">
        </div>
    </div>
    ...
    <div class="contact-content-form-company">
        ...
        <div class="contact-content-form-company-input-container">
            <input type="text" id="company" class="contact-content-form-company-input" placeholder="Novincept">
        </div>
    </div>
    ...
    <div class="contact-content-form-submit">
